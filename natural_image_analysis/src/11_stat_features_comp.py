...
=======================
Statistical analysis of Natural Image Complexity features across 4 groups.
Normality-based test selection (Parametric vs Non-Parametric).

Outputs:
- results/figures/11_ni_comp_stats_distribution.png
- results/tables/11_ni_comp_stats.csv
"""
...
pd.DataFrame(stat_results).to_csv(os.path.join(TAB_DIR, '11_ni_comp_stats.csv'), index=False)

# ── Visualization ─────────────────────────────────────────────────────────────
sns.set_theme(style="whitegrid", palette="muted")
COLORS = ['#2563EB', '#1D4ED8', '#E11D48', '#BE123C']

fig, axes = plt.subplots(2, 3, figsize=(21, 18), facecolor='#F8FAFC')
axes = axes.flatten()
...
fig.suptitle('Natural Image Complexity Features: Statistical Survey', 
...
fig_out = os.path.join(FIG_DIR, '11_ni_comp_stats_distribution.png')
